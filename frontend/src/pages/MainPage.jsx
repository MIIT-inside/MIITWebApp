...
export default function MainPage() {
    return (<div>
        ...
        <div className="flex justify-between mt-16 mx-auto max-w-[1280px]">
        ...
        <div className="bg-[#F3F4F6]">
            <div className="flex mt-16 pt-16 pspace-x-8 justify-between mx-auto max-w-[1280px]">
                <div className="flex-col w-[50%]">
                    <div className="flex flex-col space-y-14">
                        <span className="text-4xl font-bold">About РУТ(МИИТ)</span>
                        <span className="text-xl text-[#1E1E1E]">РУТ(МИИТ) is dedicated to enhancing the navigation experience for prospective students. Our goal is to provide comprehensive information about courses and career paths, ensuring students make informed decisions about their future.</span>
                    </div>
            ...
            <div className="flex justify-between mt-28 mx-auto max-w-[1280px]">
                <span className="text-4xl font-bold">Обзор наших курсов</span>
                <div className="flex flex-col w-[50%] space-y-7">
                    <span className="text-xl text-[#1E1E1E]">Наши курсы предлагают уникальные возможности для студентов, стремящихся к успешной карьере. Узнайте больше о каждом курсе, его учебной программе и карьерных перспективах.</span>
                    <div className="flex space-x-4">
