                ...
                <div>
                    <div className="flex flex-col mt-10 max-w-[1280px] mx-auto pb-16">
                        <FadeInSection>
                            ...
                            <div className="text-2xl text-gray-600 mt-10">Для успешного поступления в наш вуз важно ориентироваться на проходные и средние баллы прошлых лет, которые помогут вам оценить шансы на зачисление и спланировать подготовку. В этом разделе вы найдете актуальные данные о проходных и средних баллах по каждому направлению. Эти показатели дают общее представление о конкурсной ситуации и помогут вам определиться с выбором направления.</div>
                        </FadeInSection>
                        <FadeInSection>
                            <div>
